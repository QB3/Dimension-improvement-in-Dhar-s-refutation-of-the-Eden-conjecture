...
vector< vector<double> > tabTau2(int Niterme, int Njterme, int NiNeeded, int d ){
    ...
    vector<double> tab_int(tabTau1(Njterme, d));//cretes a 1-dimensional array
    double A=0.787064;
	...
	vector< vector<double> > tabNeeded(NiNeeded+1, vector<double>(Njterme+1));//creates a 2-dimensional array
